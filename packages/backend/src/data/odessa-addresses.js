...
exports.ODESSA_DRIVE_BOUNDS = exports.ODESSA_BOUNDS = exports.ODESSA_ADDRESSES = void 0;
exports.clampToOdessaDriveBounds = clampToOdessaDriveBounds;
exports.ODESSA_ADDRESSES = [
 ...
 */
function maxLngOnLandForLat(lat) {
    if (lat >= 46.508)
        return 30.756;
    if (lat >= 46.488)
        return 30.752;
...
function clampToOdessaDriveBounds(lat, lng) {
    let clat = Math.max(exports.ODESSA_DRIVE_BOUNDS.latMin, Math.min(exports.ODESSA_DRIVE_BOUNDS.latMax, lat));
    let clng = Math.max(exports.ODESSA_DRIVE_BOUNDS.lngMin, Math.min(exports.ODESSA_DRIVE_BOUNDS.lngMax, lng));
...
//# sourceMappingURL=odessa-addresses.js.map