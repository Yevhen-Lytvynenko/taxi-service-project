 ...
 * 1) EXPO_PUBLIC_API_URL у .env (обов’язково для реального телефону в тій же мережі)
 * 2) extra.apiUrl у app.json
 * 3) Android емулятор → 10.0.2.2 (хост ПК)
 * 4) iOS симулятор / інше → localhost
 */
