    ...
    <View style={[styles.shell, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={styles.menu}>
          <Pressable style={styles.menuRow} onPress={() => navigation.navigate('DriverEarnings')}>
            <MaterialCommunityIcons name="cash-multiple" size={22} color={colors.primary} />
            <Text style={styles.menuText}>Дохід за період</Text>
            <MaterialCommunityIcons name="chevron-right" size={22} color={colors.onSurfaceMuted} />
          </Pressable>
          <Pressable style={styles.menuRow} onPress={() => navigation.navigate('SavedRoutes')}>
            <MaterialCommunityIcons name="routes" size={22} color={colors.primary} />
            <Text style={styles.menuText}>Збережені маршрути</Text>
            <MaterialCommunityIcons name="chevron-right" size={22} color={colors.onSurfaceMuted} />
          </Pressable>
          ...
          <Pressable style={styles.menuRow} onPress={() => navigation.navigate('Contacts')}>
            ...
            <Text style={styles.menuText}>Обране та заблоковані клієнти</Text>
            <MaterialCommunityIcons name="chevron-right" size={22} color={colors.onSurfaceMuted} />
          </Pressable>
          <Pressable
